...
$PayPalApiUsername 	= 'sb-47eq6b8805527_api1.business.example.com'; 		//PayPal API Username
$PayPalApiPassword 	= 'HV9RMMVU7TNZ9Z9K'; 		//Paypal API password
$PayPalApiSignature = 'AxSYjRheSzs0PtjC1ICWpsQYYckeABchVFUGsOySfTT2w5C.Dh0pqhuA'; 		//Paypal API Signature
$PayPalCurrencyCode = 'SGD'; 	//Paypal Currency Code
//URL to redirect to after PayPal has complete the online payment
$PayPalReturnURL 	= 'http://localhost:8081/HelloDonuts/checkoutProcess.php'; 
//URL to redirect to if user clicks cancel                
$PayPalCancelURL 	= 'http://localhost:8081/HelloDonuts/shoppingCart.php'; 
